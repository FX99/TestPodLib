...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/lanfudong/TestPodLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'lanfudong' => 'lanfudong@58.com' }
  s.source           = { :git => 'https://github.com/lanfudong/TestPodLib.git', :tag => s.version.to_s }
